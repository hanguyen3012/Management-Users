...
//     username: yup.string().required('auth:username_is_required'),
//     address: yup.string().required('auth:address_is_required'),
//     birthday: yup.string().required('auth:birthday_is_required'),
//     phone: yup
//       .string()
//       // .min(10, "Phone number contain at least 10 numbers")
//       // .max(11, "Phone number contain at least 11 numbers")
//       .required('auth:phone_is_required'),
//   });
